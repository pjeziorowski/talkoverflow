...
You can get all of the above by contributing to **Gatsby.js** - one of the two most popular frameworks on top of React. In this post
...
Very often these issues are created by **core Gatsby members** and outsourced to the community, here are two examples that I found and issued a pull request:
...
**If you don't know what to build with Gatsby, you can start with coding your own blog** - *this will improve your skills and benefit your programming career both*.
