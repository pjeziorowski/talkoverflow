...
hero: "./images/react-blog.png"
author: Patryk Jeziorowski
slug: creating-gatsby-blog 
---
...
## Our goal:
![Overreacted.io](./images/overreacted.jpg)
## Prerequisites
...
Now it's time to navigate to [Netlify.com](https://netlify.com) and register & login

When you're logged in, navigate to your `Profile` -> `Sites`

![Netlify](./images/netlify-sites.jpg)
...
![Netlify](./images/netlify-github.jpg)

<br />

After authorization, a list of repositories should appear:
![Netlify](./images/netlify-repos.jpg)
...
![Netlify](./images/deploy-netlify.jpg)

And that's all! After a minute, your site will be up and running. You can check its URL here:
![Netlify](./images/netlify-url.jpg)

Done & Deployed!
![Netlify](./images/netlify-deployed.jpg)
