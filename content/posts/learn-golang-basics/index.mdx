...
hero: ./images/golang.png
slug: learn-golang-basics 
---
# Introduction
...
Next, most of Go files have a few **import statements**. Here you declare packages that you use so that your programs load a compile quickly. You don't want to include everything in your program! Go compiler will not let you import packages that you don't use, which is great!

![Learn Golang Basics](./images/golang-intro.jpg)
...
# Booleans
**Bool** value represents one of the two - true or false. They are very useful in conditional statements - similarly to all other programming languages.
...
# Types
**Go is statically typed** - the **type of each variable is known at the compilation time**. Functions expects arguments to be of a particular type. They also return values of previously defined type. If you use incorrect type, the Golang compiler will let you know even before you run the program.
...
![Learn Golang Basics](./images/reassign-error.jpg)
...
![Learn Golang Basics](./images/compile-go.jpg)

<br/>

# Conclusions
Nice! In this introductory post, you've compiled and executed a Go application on your computer. You've also learnt the basics of the language. You're definitely ready to play with Golang to learn more! In the next posts, we'll introduce more advanced concepts of the language. If you want to get a notification about the next post, subscribe to the newsletter. Thank you for reading!
