...
---
In the [previous post](/what-are-design-patterns), you learned what design patterns are. Now, it’s time to introduce the first creational design pattern - **Factory Method**.

## High-level overview

Factory Method is a **creational** design pattern, it’s main goal is to **delegate the creation of used objects to subclasses**. As it uses inheritance, it’s a **class-scope** design pattern. 
...
<div className="Image__Small">
  <img
    src="./images/factory-method.jpg"
    title="Factory pattern diagram"
...
This is a very simple interface for weapons - weapon can simply smash enemy warrior.
...
As you can see, the creation of specific weapons is delegated to specific creators. Specific warriors can decide which weapon to use.
